                ...
                <div class="title-page left">
                    <div class="title-breadcrambs left">
                        <span><?php _e('Search', tk_theme_name()); ?></span>
                             ...
                             <?php if(!have_posts()){?><p class="current" style="background:none !important"><?php _e('No posts found. Try a different search?', tk_theme_name()); ?></p><?php }else{ if (function_exists('dimox_breadcrumbs')) dimox_breadcrumbs(); }?>
                        </div>
                </div><!--/title-page-->
