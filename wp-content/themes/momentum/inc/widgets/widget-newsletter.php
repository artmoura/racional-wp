...
class App_Newsletter extends WP_Widget {
   ...
   function App_Newsletter() {
       ...
       parent::WP_Widget(false, $name = __(tk_theme_name().' - Newsletter', 'eventor'), $widget_ops);
   }
   ...
   function form($instance) {
		...
		?>
       <p>
	   	 <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:','eventor'); ?></label>
	       <input type="text" name="<?php echo $this->get_field_name('title'); ?>"  value="<?php echo $title; ?>" class="widefat" id="<?php echo $this->get_field_id('title'); ?>" />
       </p>
       <p>
	   	 <label for="<?php echo $this->get_field_id('newsletter_text'); ?>"><?php _e('Newsletter Text:','eventor'); ?></label>
       ...
       <p>
	   	 <label for="<?php echo $this->get_field_id('service'); ?>"><?php _e('Chose Service:', 'eventor'); ?></label><br/>
       ...
       <p>
	   	  <label for="<?php echo $this->get_field_id('mailchimp_key'); ?>"><?php _e('MailChimp API Key:','eventor'); ?></label><br/>
       ...
       <p>
	   	  <label for="<?php echo $this->get_field_id('mailchimp_list'); ?>"><?php _e('MailChimp API List:','eventor'); ?></label><br/>
       ...
       <p>
	   	  <label for="<?php echo $this->get_field_id('sendloop_user'); ?>"><?php _e('Sendloop Username:','eventor'); ?></label><br/>
       ...
       <p>
	   	  <label for="<?php echo $this->get_field_id('sendloop_list'); ?>"><?php _e('Sendloop List ID:','eventor'); ?></label><br/>
