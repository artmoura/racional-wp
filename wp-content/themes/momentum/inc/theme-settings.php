...
function tk_settings_page_init() {
    global $wp_version;
    $tk_theme_name = ucwords(tk_theme_name);
    $pages = @get_all_pages();
    ...
    for ($i = 0; $i <= count($pages) - 1; $i++) {
        if ($i == 0) {
            $settings_page .= add_menu_page($pages[$i]['slug'], $tk_theme_name, 'edit_theme_options', $pages[$i]['slug'], 'tk_settings_page');
                                ...
                                if ($row_items == 4) {
                                    if (count($r2) > 0) {
                                        ...
                                        foreach ($r2 as $r3) {
                                            ...
                                            if ($r3['type'] == 'adds') {//TYPE: dropdown Authors
                                                echo 'test';
                                            }                                        
